            ...
            <div className="container mx-auto px-4 md:px-0 ">
                ...
                {/* contact work header wrapper  */}
                     <div className='flex items-center justify-center flex-col gap-6  mb-10'>
                        <h3 className='text-5xl font-josefin capitalize font-semibold bg-gradient-to-r from-[#5dffff] to-[#ae0ca7] bg-clip-text text-transparent '>Contact</h3>
                     </div>
                ...
                <div className='md:flex  justify-between gap-10 space-y-10 md:space-y-0'>
                  {/* text wrapper */}
                     ...
                     {/* contact wrapper */}
                     <form className='md:w-1/2 w-full flex flex-col gap-6 p-6 shadow-2xl shadow-[#fafafa] rounded-3xl'>
