            ...
            <div className='container mx-auto px-4 md:px-0'>
                <div className="flex items-center flex-col justify-center">
                    ...
                    <div className="flex items-center justify-center flex-col gap-6 mb-10">
                        ...
                        <motion.h3 initial={{ opacity: 0, y: -100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='text-5xl font-josefin capitalize 
                         font-semibold bg-gradient-to-r from-[#5dffff] to-[#ae0ca7]
                         bg-clip-text text-transparent'>
                            About
                        </motion.h3>

                        <motion.p initial={{ opacity: 0, y: -100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='text-xl text-[#fafafa] font-josefin font-normal leading-7
                                          max-w-[800px] w-full'>
                            i'm a Entry level front-end developer looking
                    ...
                    <motion.dev initial={{ opacity: 0, y: 200 }}
